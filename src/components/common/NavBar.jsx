...
const NavBar = () => {
    return (
        <div className='w-full h-[46px] mt-10 flex justify-between fixed top-0 left-0 mix-blend-difference items-center z-100 px-20'>
            {/* Left */}
            ...
            {/* Right */}
            <div className='w-1/3 h-full items-center flex justify-between uppercase text-[18px]  text-white'>
                <Link href={`/wedding`}><div className='w-fit h-fit flex flex-col group relative  select-none cursor-pointer'> <div className=' absolute bottom-0 left-0 w-0 h-0.5 group-hover:w-full duration-200 ease-out bg-[#5F171D]'></div> Services</div></Link>
                ...
                {/* BTN */}
                <div className='w-[114px] h-[46px] select-none cursor-pointer flex justify-center items-center px-[17px] py-[6px] text-[18px] bg-[white] text-black'>
                    RSVP
                </div>
            </div>
        </div>
