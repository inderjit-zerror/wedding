...
const NavBar = () => {
  ...
  return (
    <div ref={navRef} className='w-full h-[46px] mt-10 flex justify-between fixed top-0 left-0   items-center z-100 px-20'>
      {/* Left */}
      <div className='w-1/3 h-full items-center flex justify-between uppercase text-[16px] text-white '>
      ...
      <div className='w-1/3 h-full items-center flex justify-between uppercase text-[16px]  text-white'>
        ...
        {/* BTN */}
        <div className='w-[114px] h-[46px] select-none cursor-pointer flex justify-center items-center px-[17px] py-[6px] text-[16px] text-[white] bg-[#5F171D] hover:bg-[#632127]'>
          RSVP
        </div>
      </div>
    </div>
